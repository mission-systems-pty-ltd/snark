...
namespace snark { namespace math { namespace applications { namespace fft { namespace basic {
...
output options
    ...
    oss << "csv options" << std::endl;
    oss << comma::csv::options::usage( verbose ) << std::endl;
    oss << R"(examples
...
template <> struct traits< snark::math::applications::fft::basic::input_t >
{
    template< typename K, typename V > static void visit( const K& k, snark::math::applications::fft::basic::input_t& p, V& v ) { v.apply( "data", p.data ); }
    template< typename K, typename V > static void visit( const K& k, const snark::math::applications::fft::basic::input_t& p, V& v ) { v.apply( "data", p.data ); }
};

template <> struct traits< snark::math::applications::fft::basic::output_t >
{
    template< typename K, typename V > static void visit( const K& k, const snark::math::applications::fft::basic::output_t& p, V& v ) { v.apply( "output", p.data ); }
};
