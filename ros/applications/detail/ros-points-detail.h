...
// Forward decleration - required to compile when linking to only ros1 or ros2.
...
struct pointcloud
{
    ...
    std::string msg_fields_names( const sensor_msgs::msg::PointCloud2::_fields_type& msg_fields
    ...
    comma::csv::format msg_fields_format( const sensor_msgs::msg::PointCloud2::_fields_type& msg_fields
                                        , const std::vector< std::string >& field_filter = std::vector< std::string >()
    ...
    public:
        ...
        bin_shuffle( const std::string& field_names
                , const sensor_msgs::msg::PointCloud2::_fields_type& msg_fields
                , const rclcpp::Time& header_time_stamp
                , bool ignore_time_format )
            : header_time_stamp( snark::ros::time::to_boost( header_time_stamp ) )
            ...
            for( const auto& field_desc : field_descs )
            {
                if( field_desc.is_time_field )
                {
                    ...
                    if( !ignore_time_format )
                    {
                        ...
                        if( field_desc.datatype == sensor_msgs::msg::PointField::FLOAT32 ||
                            field_desc.datatype == sensor_msgs::msg::PointField::UINT32 )
                        {
    ...
    struct header
    {
        ...
        uint32_t block{0};
        header() : block( 0 ) {}
        header( const rclcpp::Time& time, uint32_t seq ) : t( snark::ros::time::to_boost( time ) ), block( seq ) {}
    };

    /// process ros sensor_msgs::msg::PointCloud2 message
    class points
    {
    public:
        ...
        void process( const sensor_msgs::msg::PointCloud2::SharedPtr input )
        {
            try
            {
                ...
                for( unsigned int i = 0; i < count; i++ )
                {
                    ...
                    if( !std::cout.good() ) { rclcpp::shutdown(); break; }
                }
            }
            catch( std::exception& ex ) { std::cerr << comma::verbose.app_name() << ": exception: " << ex.what() << std::endl; status = 1; rclcpp::shutdown(); }
            catch( ... ) { std::cerr << comma::verbose.app_name() << ": " << "unknown exception" << std::endl; status = 1; rclcpp::shutdown(); }
        }
...
class to_point_cloud
{
    struct field_desc
    {
        sensor_msgs::msg::PointField point_field; // includes name,offset,datatype,count for ROS data
        comma::csv::format::types_enum input_type;
        std::size_t input_offset;
        std::size_t size;               // target size = sizeof( output datatype ) * count

        field_desc( sensor_msgs::msg::PointField point_field
                  , comma::csv::format::types_enum input_type
                  , std::size_t input_offset
                  , std::size_t size )
...
public:
    ...
    sensor_msgs::msg::PointCloud2 create_msg( const std::vector< record >& records )
    {
        unsigned int count = records.size();
        sensor_msgs::msg::PointCloud2 msg;

        std::vector< sensor_msgs::msg::PointField > point_fields;
        ...
        msg.header.stamp = snark::ros::time::from_boost( msg_start_time );
...
private:
    ...
    unsigned int map_data_type( comma::csv::format::types_enum t )
    {
        switch(t)
        {
            ...
            case comma::csv::format::int8:     return sensor_msgs::msg::PointField::INT8;
            case comma::csv::format::uint8:    return sensor_msgs::msg::PointField::UINT8;
            case comma::csv::format::int16:    return sensor_msgs::msg::PointField::INT16;
            case comma::csv::format::uint16:   return sensor_msgs::msg::PointField::UINT16;
            case comma::csv::format::int32:    return sensor_msgs::msg::PointField::INT32;
            case comma::csv::format::uint32:   return sensor_msgs::msg::PointField::UINT32;
            case comma::csv::format::float_t:  return sensor_msgs::msg::PointField::FLOAT32;
            case comma::csv::format::double_t: return sensor_msgs::msg::PointField::FLOAT64;
            ...
            case comma::csv::format::time:
                {
                    switch( time_format )
                    {
                        case time_format_enum::none:               comma::verbose << "warning: ROS PointCloud2 doesn't support data type '"
                                                                                  ...
                                                                                  << "', using FLOAT64 instead" << std::endl;
                                                                   return sensor_msgs::msg::PointField::FLOAT64;
                        case time_format_enum::offset_seconds:     return sensor_msgs::msg::PointField::FLOAT32;
                        case time_format_enum::offset_nanoseconds: return sensor_msgs::msg::PointField::UINT32;
                    }
                }
            default:
...
public:
    ...
    void send( const std::function< void( sensor_msgs::msg::PointCloud2 ) >& publisher_fn )
    {
        //create msg
        sensor_msgs::msg::PointCloud2 msg = point_cloud.create_msg( records );
        publisher_fn( msg );
        records.clear();
    }
