...
static void usage( bool )
{
    ...
    static const char * const usage_options =
        ...
        "\n    keys"
        "\n        r: restore camera position"
        "\n        ctrl-r, shift-ctrl-r: iterate through stored camera positions"
        "\n        v: push the current camera position"
        "\n        ctrl-v: pop the oldest camera position"
        "\n    options"
        "\n        --camera=\"<options>\""
