...
static void usage( bool verbose )
{
    ...
    std::cerr << "    io-console | control-console | my-app-using-poses-on-stdin" << std::endl;
    std::cerr << "    io-console | control-console --binary 6f | my-app-using-poses-on-stdin --binary=6f" << std::endl;
    std::cerr << std::endl;
    std::cerr << "input: key codes as binary bytes; same as io-console output" << std::endl;
    std::cerr << std::endl;
    std::cerr << "output: x,y,z,roll,pitch,yaw" << std::endl;
    std::cerr << std::endl;
    ...
    std::cerr << "    --binary=[<format>]; output pose as binary" << std::endl;
    std::cerr << std::endl;
    exit( 0 );
}
